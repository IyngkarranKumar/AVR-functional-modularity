...
class perception_feature_extraction(nn.Module):
...
class contrast(nn.Module):
    ...
    def forward(self,input_features,contrast1_bias,contrast2_bias):
        
        #pass features through two contrast layers
        ...
        res1_in = res1_in - res1_contrast.unsqueeze(1) #we effectively apply contrasting twice(?)
        ...
        res2_in = res2_in - res2_contrast.unsqueeze(1) #KEY STEP
...
class inference_rule_transform(nn.Module):
    
    def __init__(self,num_rule,num_attr):
        super().__init__()
    ...
    def forward(self,predict_rules):
        ...
        return contrast1_bias,contrast2_bias
        
        

class inference_feature_extraction(nn.Module):
